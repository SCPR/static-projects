        ...
        renderSearchView: function(){
            $(".data-visuals").html(
                "<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>" +
                    "<div id='DC-search-projectid-15522-lausd-ipad-emails' class='DC-search-container'></div>" +
                "</div>"
            );
            dc.embed.load('http://www.documentcloud.org/search/embed/', {
                q: "projectid: 15522-lausd-ipad-emails ",
                container: "#DC-search-projectid-15522-lausd-ipad-emails",
                order: "title",
                per_page: 6,
                search_bar: true,
                organization: 97
