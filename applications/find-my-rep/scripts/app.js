(function(){
    ...
    $(function(){
        ...
        Backbone.history.start({
            root: 'https://projects.scpr.org/applications/find-my-rep/',
            pushState: false,
        });
    });
...
var embed_url_root = 'https://projects.scpr.org/applications/find-my-rep/';

var initializeTemplates = {
    renderStaticTemplates: function(){
        var proxyPrefix = 'https://projects.scpr.org/static-files/v3-dependencies/templates/';
