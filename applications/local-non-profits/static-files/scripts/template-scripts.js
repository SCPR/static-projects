...
// create data details template
function renderDataModalTemplate(){
    getTemplateAjax('static-files/templates/data-modal.handlebars', function(template) {
        jqueryNoConflict('#data-modal').html(template());
    })
};
