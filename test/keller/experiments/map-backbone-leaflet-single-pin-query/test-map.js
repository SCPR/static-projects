(function(){
    ...
    App.Collections.Responses = Backbone.Collection.extend({
        ...
        url: "https://www.publicinsightnetwork.org/air2/api/public/search?a=6f4d503616e1115157a64bd26b51aec7&q=query_uuid:298a682e1a77&t=JSON",
    ...
    App.Router = Backbone.Router.extend({
        ...
        mainView: function(){
            this.responsesCollection = new App.Collections.Responses();
        ...
        createMap: function(mapContainer, collection, initialZoom){
        //createMap: function(mapContainer, collection, template, initialZoom){
