    ...
    var dataConfig = {
        ...
        dataSpreadsheetKey: '0AjsyCVrBXivzdGhjR0k0TS15TlVTVm5XaDRTZnRPTGc',
            ...
            Tabletop.init({
                ...
                processDataSource: function(data, tabletop){
                    ...
                    // get unique categories and place them as key to frequency
                            var eventCategoriesObject = dataConfig.separateKeysFromValues(data);
                    ...
                    var keys = Object.keys(eventCategoriesObject);
