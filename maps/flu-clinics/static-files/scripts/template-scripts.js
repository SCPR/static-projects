...
// create data details template
function renderDataMapSearchTemplate(){
    getTemplateAjax('static-files/templates/data-map-search.handlebars', function(template) {
        jqueryNoConflict('#data-map-search').html(template());
    })
};
