...
const audio = [
      {
        ...
        "captions": {
              ...
              "23":  "I'm standing in the middle of a long, triangle-shaped lot in west Fullerton with David Gillanders.",
              ...
              "36":  "Well, right now it's a city yard, so there's some railroad tracks, there's all kinds of construction materials, trucks...",
              ...
              "95": "But some neighbors don't see David's proposal as a solution at all.",
              "99": "Fullerton's known for its scenic trails.",
              ...
              "112": "Ahi sandwich? Oh yes, thank you. Sorry about that.",
              "115": "The two live a few blocks from where the Pathways apartments would be built. Nina and Stephanie are leading the opposition. Their arguments might sound familiar.",
      ...
      },
      {
        ...
        "captions": {
              ...
              "62": "No. Um, if we see it in the community and it's causing a problem and a lease violation, then yes, they would get written up. We don't go in and do checks for alcohol...",
              "72": "This doesn't go over well with Christina Brittain.",
              "75": "Ultimately what I'm hearing from this is that our tax dollars, ultimately, are going towards supporting this, I understand that part. And that if they're doing drugs in their own little thing, that's their business, we don't see it. If you know about it, you try to help them, but don't force them to get help.",
              ...
              "149": "So I'm going to waste my time having everything sugar-coated by these people?",
              "154": "Shari lives a few blocks from the site where Pathways wants to build 60 units of permanent supportive housing in Fullerton.",
              ...
              "195": "It has stylish, eco-friendly landscaping and a huge community food garden out back. The tour leaders address the standard concerns, like security.",
              "202": "And we have security gates and security guards...",
              "205": "The Pathways project would also have security. But by this point it's become clear that some of the neighbors don't care about assurances. They just want Pathways to house homeless people somewhere else. ",
