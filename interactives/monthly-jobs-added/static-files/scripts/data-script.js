...
*/
    ...
    // chart options
    var chart;
    var chartCategories = ['J12', 'F12', 'M12', 'A12', 'M12', 'J12', 'J12', 'A12', 'S12', 'O12', 'N12', 'D12', 'J13', 'F13', 'M13', 'A13', 'M13', 'J13', 'J13', 'A13'];
    ...
    function showInfo(data, tabletop){
        ...
        jqueryNoConflict.each(tabletop.sheets(dataSheet).all(), function(i, record) {
            ...
            var jun2013 = parseInt(record.jun2013);
            var july2013 = parseInt(record.jul2013);
            var aug2013 = parseInt(record.aug2013);

            // build array from each row of spreadsheet
            allJobsData = [jan2012, feb2012, mar2012, apr2012, may2012, jun2012, jul2012, aug2012, sep2012, oct2012, nov2012, dec2012, jan2013, feb2013, mar2013, apr2013, may2013, jun2013, july2013, aug2013];
...
*/
            ...
            console.log(differenceMonthlyJobs);
