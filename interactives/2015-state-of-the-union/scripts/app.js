...
var fn = {
    ...
    processDocumentMetaData: function(data){
        jqueryNoConflict('#document-meta-data').html("<h6><span id='speech-topic'>Click an icon to see what President Obama said about a particular topic in his State of the State address.</span></h6>"
        );
