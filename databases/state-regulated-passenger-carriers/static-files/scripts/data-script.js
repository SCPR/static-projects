...
var defaultTableOptions = {
    ...
    jsonFile: 'static-files/data/state-passenger-carriers-handlebars.json',
    ...
    dataHeaders: ['carrier_name', 'carrier_location', 'county', 'details_url'],

    // proper display names as you want them to appear in the table
    columnHeaders: ['Carrier', 'Location', 'County', 'Carrier Profile'],
